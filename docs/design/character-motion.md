...
操作與證據見 [pitcher README](../../pawapuro/batting/pitcher/README.md#style-polish-v1a125-planar-feet-candidate)，技術結果由 [environment](../development/environment.md#style-polish-v1a-larger-grounded-feet2026-09-16) 擁有。S3 delivery 已獲 Michael＋Julia human acceptance；dynamic occlusion／presentation polish 仍可保留為非 blocker debt。Batter Motion Brief 已接受，Authoring S0 candidate 待 human review，batter runtime／碰撞未開始；M1 未完成，六條 rules 原文不變。
