...
更新：2026-09-14。狀態：已完成 M1 Step 0 環境核對與專案指引；尚未開始 Step 1 implementation。
...
| [開發環境核對](development/environment.md) | Step 0 實測工具、Step 1 最低依賴與尚待處理項目。 |
...
- 專案已納入 Git；本輪僅新增／更新 Markdown 指引與環境紀錄。依賴準備與 Step 1 coding 仍須另行授權。
