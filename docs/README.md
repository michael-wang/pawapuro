...
| [Hit Authorization S0](design/batting-contact.md) | Intent → authorization → physical resolution → quality → response 的候選責任；待 review，未實作。 |
