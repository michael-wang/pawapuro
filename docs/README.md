...
更新：2026-09-14。狀態：已完成 M1 Step 0 與 Step 1 交付 1 的靜態場景驗證；另已完成 staging calibration／啟動 Data 與交付 2 的固定步長 reference pitch；交付 3 尚未開始。
...
- 目前程式提供單顆固定步長 reference pitch、pause／single-step；重投與投手動畫仍須另行授權。
