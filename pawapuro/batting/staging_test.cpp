...
int main(int argc, char** argv)
{
    try {
        ...
        const Invalid invalid[] = {
            ...
            {"[ground_ball_response]\nimpact_horizontal_retention = 0\n", "ground_ball_response"},
            {"[ground_ball_response]\nimpact_horizontal_retention = -1\n", "ground_ball_response"},
            {"[ground_ball_response]\nimpact_horizontal_retention = 1.1\n", "ground_ball_response"},
            {"[ground_ball_response]\nimpact_horizontal_retention = inf\n", "ground_ball_response"},
            {"[ground_ball_response]\nroll_deceleration_mps2 = 0\n", "ground_ball_response"},
            {"[ground_ball_response]\nroll_deceleration_mps2 = -1\n", "ground_ball_response"},
            {"[ground_ball_response]\nroll_deceleration_mps2 = nan\n", "ground_ball_response"},
            {"[ground_ball_response]\nroll_deceleration_mps2 = 'x'\n", "ground_ball_response"},
            {"[ground_ball_response]\nunknown = 1\n", "ground_ball_response"},
            {"[unknown]\n", "Unknown staging key"},
